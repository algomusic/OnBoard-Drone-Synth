...
4. In ESPConnect tick the ‘Connect’ button and select the port for the Beat Machine and click
‘connect’ in the popup dialog. ESPConnect should display info about the ESP32 chip.
5. On the left of the ESPConnect site, click ‘Flash Tools’. Scroll down to the ‘Flash Firmware’
section of the page.
7. Drag the Drone_Machine...ino.bin file from your computer onto the Firmware Binary
area of the ESPConnect site.
8. From the ‘Recommended OXsets’ menu select ‘app0 - 0X10000’
9. Click the ‘Flash Firmware’ button, confirm if required, then wait for the firmware to be
uploaded.
10. The Drone Synth should restart.
11. If the buttons on the Drone Synth are unresponsive then press the Reset button on the ESP32.
